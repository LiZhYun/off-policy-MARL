import numpy as np
import torch
from offpolicy.algorithms.maven.algorithm.agent_q_function import AgentQFunction
...
class M_QMixPolicy(MLPPolicy):
    ...
    def get_q_values(self, obs_batch, noise, action_batch=None):
        """
        ...
        """
        q_batch = self.q_network(obs_batch, noise)
    ...
    def get_actions(self, obs_batch, noise, available_actions=None, t_env=None, explore=False):
        """
        See parent class.
        """
        batch_size = obs_batch.shape[0]
        q_values_out = self.get_q_values(obs_batch, noise)
