...
class PredatorPreyWrapper(PredatorPrey):
    ...
    def step(self, actions):
        ...
        obses, rewards, dones, infos = super().step(actions_int)
        return obses, np.concatenate(obses), rewards, dones, infos, self.get_avail_actions()

    def reset(self):
        obses = super().reset()
        return obses, np.concatenate(obses), self.get_avail_actions()
