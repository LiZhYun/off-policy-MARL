...
class MlpRunner(object):
    ...
    def __init__(self, config):
        ...
        if self.algorithm_name == "macpf":
            from offpolicy.algorithms.macpf.algorithm.MACPFPolicy import MACPFPolicy as Policy
            from offpolicy.algorithms.macpf.macpf import MACPF as TrainAlgo
        else:
    ...
    def batch_train(self):
        ...
        for p_id in self.policy_ids:
            ...
            train_info, new_priorities, idxes = update(p_id, sample, True)
            train_info, new_priorities, idxes = update(p_id, sample, False)
