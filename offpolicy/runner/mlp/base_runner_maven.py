...
from offpolicy.utils.mlp_buffer_maven import MlpReplayBuffer, PrioritizedMlpReplayBuffer
...
class MlpRunner(object):
    ...
    def __init__(self, config):
        ...
        self.q_learning = ["mqmix","mvdn","maven"]
        ...
        if self.algorithm_name == "maven":
            from offpolicy.algorithms.maven.algorithm.mQMixPolicy import M_QMixPolicy as Policy
            from offpolicy.algorithms.maven.mqmix import M_QMix as TrainAlgo
            from offpolicy.algorithms.maven.algorithm.uniform import Uniform
        else:
        ...
        if self.use_per:
            ...
            self.buffer = MlpReplayBuffer(self.args, self.policy_info,
                                          self.policy_agents,
                                          self.buffer_size,
                                          self.use_same_share_obs,
                                          self.use_avail_acts,
